...
object PlayerNavigation {
    const val ROUTE =
        "player/{trackId}/{trackName}/{artistName}/{artworkUrl}/{collectionId}/{trackTimeMillis}"
    ...
    const val ARG_TRACK_TIME_MILLIS = "trackTimeMillis"

    const val NO_COLLECTION_ID = -1L
    const val NO_TRACK_TIME_MILLIS = -1L
